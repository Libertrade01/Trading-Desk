  ...
  return (
    <LegalPage eyebrow="PRIVACY / COOKIES" title="Only what the product needs." intro="This notice explains the cookies and similar browser storage used by the Libertrade beta." effective={PRIVACY_VERSION}>
      ...
      <LegalSection title="Analytics">
        <p>Libertrade uses Vercel Web Analytics on public pages to understand aggregate visits, page views, referrers, general location, browser and device type, and anonymous interactions in the signup funnel. It does not use analytics cookies or build a persistent profile across different days or websites. Analytics are not loaded inside authenticated journal and account pages.</p>
        <p>We do not send names, email addresses, dates of birth, passwords, form values, trading records, journal text or account identifiers as analytics events. Libertrade does not use advertising trackers.</p>
      </LegalSection>
